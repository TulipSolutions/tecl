...
const privateOrderServiceGetEventsForOrder = require('./privateOrderServiceGetEventsForOrder');
const privateOrderServiceGetOrderEvents = require('./privateOrderServiceGetOrderEvents');
const privateOrderServiceStreamOrderEvents = require('./privateOrderServiceStreamOrderEvents');
...
privateOrderServiceGetEventsForOrder(host, credentials, options);
privateOrderServiceGetOrderEvents(host, credentials, options);
privateOrderServiceStreamOrderEvents(host, credentials, options);
